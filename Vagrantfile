...
WP_DEFAULT_PLUGINS   = %w(theme-check plugin-check dynamic-hostname contact-form-7 wp-pagenavi meta-box google-sitemap-generator cyr3lat wp-sitemap-page) # default plugins
WP_DEFAULT_THEME     = 'https://github.com/Dimasmagadan/kpd-wp-theme/archive/kpdtheme.zip' # e.g. twentythirteen
